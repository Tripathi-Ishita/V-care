                              ...
                              child: Column(
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () {Navigator.push(context,MaterialPageRoute(builder: (context)=>Healthtip()) );},
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(5.0),
                                    child: Text(
